...
import bank.integration.AccountChangeEvent;
...
public class AccountService implements IAccountService {
	...
	public void deposit(long accountNumber, double amount) {
		...
		applicationEventPublisher.publishEvent(new AccountChangeEvent(accountNumber, "deposit", amount));
	}
	...
	public void withdraw(long accountNumber, double amount) {
		...
		logger.log("withdraw with parameters accountNumber= " + accountNumber
				+ " , amount= " + amount);
		applicationEventPublisher.publishEvent(new AccountChangeEvent(accountNumber, "withdraw", amount));
	...
	public void depositEuros(long accountNumber, double amount) {
		...
		applicationEventPublisher.publishEvent(new AccountChangeEvent(accountNumber, "depositEuros", amount));
	...
	public void withdrawEuros(long accountNumber, double amount) {
		...
		logger.log("withdrawEuros with parameters accountNumber= "
				+ accountNumber + " , amount= " + amount);
		applicationEventPublisher.publishEvent(new AccountChangeEvent(accountNumber, "withdrawEuros", amount));
	}
	...
	public void transferFunds(long fromAccountNumber, long toAccountNumber,
		...
		applicationEventPublisher.publishEvent(new AccountChangeEvent(fromAccountNumber, "transferFunds", amount));
